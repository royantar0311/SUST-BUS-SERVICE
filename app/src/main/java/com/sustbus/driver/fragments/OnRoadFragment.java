...
public class OnRoadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_on_road, container, false);
        recyclerView = root.findViewById(R.id.onroad_recycler_view);
        ...
        textView = root.findViewById(R.id.onroad_frag_tv);
